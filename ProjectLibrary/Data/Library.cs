        ...
        public Library()
        {
            Books = new List<Book>()
            {
                new Book()
                {
                    ...
                    Price = 19.01,
                    Terms = new string[] { "Sci-fi", "A Song of Ice and Fire", "dragons" },
                    Related = new int[] { 23 }
                },
                new Book()
                {
                    ...
                    Price = 5.0,
                    Terms = new string[] { "Sci-fi", "Comedy", "Meaning of Life" }
                },
                new Book()
                {
                    Id = 23,
                    ...
                    Price = 3.29,
                    Terms = new string[] { "Sci-fi", "A Song of Ice and Fire", "Epic", "Best-Seller", "Dragons" },
                    Related = new int[]{ 8 }
                },
                new Book()
                {
                    ...
                    Price = 2.0,
                    Terms = new string[] { "Sci-fi", "Aliens"}
                }
            };
        }
    }
